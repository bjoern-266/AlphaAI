...
speichert :class:`~engines.pattern_result.PatternReport`-Objekte unter einem
...
class PatternCache:
    """Größenbegrenzter Cache für Pattern-Ergebnisse.
    ...
    def __init__(self, capacity: int = 128) -> None:
        ...
        self._store: OrderedDict[str, PatternReport] = OrderedDict()
        self.hits = 0
        self.misses = 0

    def get(self, key: str) -> PatternReport | None:
    ...
    def set(self, key: str, value: PatternReport) -> None:
