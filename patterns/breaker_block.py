"""Breaker Block – vorbereitet, noch keine Erkennung.
...
class BreakerBlockPattern(BasePattern):
    """Vorbereiteter Breaker-Block-Detektor (ohne Erkennung)."""
    ...
    def detect(self, data: pd.DataFrame, params: Mapping[str, Any]) -> PatternDetection:
        ...
        return PatternDetection(warnings=["Breaker Block: vorbereitet, noch nicht implementiert."])
