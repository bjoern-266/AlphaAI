...
Ein BOS ist ein Struktur-Bruch in Richtung des bestehenden Trends. Nutzt den
gemeinsamen Struktur-Helper aus ``patterns.base`` und ist damit unabhängig von
den übrigen Mustern.
"""
...
# Ein Bruch um 2 % über das Level gilt als maximal ausgeprägt.
_FULL_SCALE_RATIO = 0.02
_CONFIDENCE = 0.7


class BosPattern(BasePattern):
    """Break-of-Structure-Detektor."""
    ...
    def detect(self, data: pd.DataFrame, params: Mapping[str, Any]) -> PatternDetection:
        """Erkennt alle BOS-Ereignisse (Trendfortsetzung)."""
