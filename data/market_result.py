"""Ergebnisobjekt für Marktdaten.

Ein :class:`MarketResult` bündelt die geladenen Kursdaten je Symbol samt
Statusinformationen, Metadaten und aufgetretenen Fehlern. Die Kursdaten liegen
als :class:`pandas.DataFrame` mit einem festen, kanonischen Spaltenschema vor,
damit alle nachgelagerten Schichten unabhängig vom Provider arbeiten können.
"""
...
class MarketResult:
    """Ergebnis einer Marktdatenanfrage.
